	...
	public void onCreate(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (stackEntryReference != currentStackEntryReference) {
                ...
                Log.w(TAG, String.format("onCreate with savedInstanceState: contains wrong stackEntryReference %s and current stack depth is %s", stackEntryReference, currentStackEntryReference));
                ScreenManagerSingleton.get().finishDisplay();
                finish();
            } else {
