...
public class TabsActivity extends ActivityGroup implements TabsActivityProtocol, OnClickListener {
	...
	private void startTab(final int index) {
		...
		ActivityHelper.startLocalActivity(this, bodyDescription.getIntent(), "tab-" + index, R.id.sl_tabs_body, ActivityHelper.ANIM_NONE);
